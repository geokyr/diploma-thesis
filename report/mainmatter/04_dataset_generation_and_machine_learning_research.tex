...
These scripts are responsible for extracting the OSM data for the specified bounding box and building the SUMO network by converting the OSM data into a SUMO-compatible network format.
