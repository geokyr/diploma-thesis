...
\begin{frame}{Contributions}
    ...
    \begin{itemize}
        ...
        \item Three \textbf{Machine Learning models}:
            ...
            \end{itemize}
            \medskip
        \item \textbf{Urban Mobility Simulation Platform} with complete automated drift lifecycle management
    \end{itemize}
...
\begin{frame}{Models \& Configuration Space}
    ...
    \begin{itemize}
        \item CV (cross validation) evaluation for all the possible configuration combos and parameters (per model)
...
\begin{frame}{Platform Overview}
    ...
    \begin{itemize}
        ...
        \item \textbf{Backend} as the orchestrator - \textbf{Frontend} for the Admin Dashboard and the User Interface - \textbf{Predictor} for the batch/single inference and retraining - \textbf{Drift} for the concept drift monitoring - \textbf{Summarizer} for the AI-powered report generation.
    \end{itemize}
\end{frame}
...
\begin{frame}{Dynamic Calibration (Task-Agnostic)}
    ...
    \textbf{Outcome}
    \begin{itemize}
        \item \textbf{Task-agnostic} deployment with a single policy and no manual tuning.
    \end{itemize}
