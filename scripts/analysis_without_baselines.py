...
from thesis.eta.results import load_research_results_without_baselines, run_metric_analysis, save_research_results
...
def main() -> None:
    ...
    logger.info(f"Running {experiment.name} experiment with {experiment.evaluation} evaluation (excluding baselines)")
