from thesis.common.data import generate_trips, get_adaptation_test_data, load_fcd_dataset, preprocess_fcd_dataset
...
def main() -> None:
    experiment = ETAExperiment(__file__, ETAEvaluation.DRIFT)
