...
This can be explained by the following facts. First of all, the way the source and destination points are selected is through the [randomTrips](https://sumo.dlr.de/docs/Tools/Trip.html) tool, which 
