...
from thesis.eta.features import add_coordinate_features, add_distance_features, split_features_and_target
...
def main() -> None:
    ...
    trips_train = add_coordinate_features(trips_train)
    trips_train = add_distance_features(trips_train)
