...
from thesis.eta.features import add_cell_features, create_quantile_normal_transformer, split_features_and_target
...
def main() -> None:
    ...
    trips_train = add_cell_features(trips_train)
