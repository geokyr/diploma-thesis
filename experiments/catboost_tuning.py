...
from thesis.eta.tuning import log_parameter_importance, run_hyperparameter_tuning
...
def main() -> None:
    ...
    study = run_hyperparameter_tuning(model_type, X_train, y_train, skf, stratify_key, transformer)
