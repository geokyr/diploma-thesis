...
from thesis.eta.features import add_fourier_features, create_quantile_normal_transformer, split_features_and_target
...
def main() -> None:
    ...
    trips_train = add_fourier_features(trips_train)
