...
from thesis.eta.features import add_hour_features, add_time_period_features, split_features_and_target
...
def main() -> None:
    ...
    trips_train = add_hour_features(trips_train)
    trips_train = add_time_period_features(trips_train)
