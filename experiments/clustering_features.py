...
from thesis.eta.features import add_clustering_features, create_quantile_normal_transformer, split_features_and_target
...
def main() -> None:
    ...
    trips_train = add_clustering_features(trips_train)
